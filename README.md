...
It's a browser-based web application built with HTML, CSS, and TypeScript. The app features interactive UI components, timed behaviours, and modular TypeScript code with unit tests powered by Jest.
